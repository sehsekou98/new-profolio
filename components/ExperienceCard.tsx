...
export default function ExperienceCard({experience}: Props) {
  return (
   ...
   space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[800px]
   ...
   <div className='px-0 md:px-10'>
    <h4 className='text-4xl font-light'>Front-end Dev at</h4>
    <p className='font-bold text-2xl mt-1'>Easy-Technology-Group</p>
    <div className='flex space-x-2 my-2'>
      ...
      <p className='list-disc space-y-4 ml-5 text-lg'>
